...
def saveData():
    ...
    messagebox.show.info("Update", "Success")
    
def viewData():
    global decryption_text_data
    text_file = filedialog.askopenfilename(title=" Open Text File", filetypes=(("Text Filles", "*.txt"),))
...
def startDecrytion():
    ...
    btn_open_file = Button(decryption_window, text="Choose File..", font = 'arial 13', bg="#E80085", padx=10, relief=FLAT, command=viewData)
    btn_open_file.place(relx=0.5,rely=0.8, anchor=CENTER)
    
    decryption_window_mainloop()
...
def startEncryption():
    ...
    file_name_label = Label(encryption_window, text="File Name: " , font = 'arial 13', bg="#82C9AB")
    ...
    btn_create = Button(encryption_window, text="Create", font = 'arial 13', bg="#E8D085", padx=10, relief=FLAT)
...
btn_start_decryption.place(relx=0.3,rely=0.6, anchor=CENTER)   
